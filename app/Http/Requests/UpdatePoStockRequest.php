...
class UpdatePoStockRequest extends FormRequest
{
    /**
    ...
    {
        return auth()->user()->can('edit PO stock');
    }
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator) {
            $poStock = $this->route('purchase_order');
            if (!$poStock instanceof PoStock) {
                return;
            }

            $mainCategoryId = (int) $poStock->main_category_id;
            ...
            if (
                ...
                $validator->errors()->add('supplier', 'This PO supplier does not belong to its main category.');
            }
            ...
            foreach ($productIds as $productId) {
                ...
                if (
                    ...
                    $validator->errors()->add(
                        'product_id',
                        "Product ID {$productId} does not match this PO category and supplier."
                    );
                }
