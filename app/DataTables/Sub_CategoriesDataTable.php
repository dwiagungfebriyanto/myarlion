...
class Sub_CategoriesDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', 'pages.product.sub_category.components.action-button')
            ->setRowId('id');
    }
     ...
     */
    public function query(Sub_Category $model): QueryBuilder
    {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('code', 'code')->title('ID'),
            Column::make('category_name', 'category_name')->title('Sub Category Name'),
