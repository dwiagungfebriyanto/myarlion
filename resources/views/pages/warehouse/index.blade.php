...
<link href="{{ URL::to('/') }}/assets/libs/datatables/responsive.bootstrap4.css"
    rel="stylesheet" type="text/css" />
<link href="{{ URL::to('/') }}/assets/libs/switchery/switchery.min.css" rel="stylesheet"
    type="text/css" />
...
@include('pages.warehouse.components.create-modal')
@include('pages.warehouse.components.edit-modal')
...
<script src="{{ URL::to('/') }}/assets/libs/switchery/switchery.min.js"></script>
