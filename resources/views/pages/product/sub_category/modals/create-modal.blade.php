            ...
            <div class="modal-body">
                <div class="form-group">
                    <div class="col-12 validate-input">
                        ...
                        <select class="form-control select2" required name="main_category"
                            id="main_category">
                ...
                <div class="form-group">
                    <div class="col-12 validate-input">
                        ...
                        <input class="form-control" type="text" id="category_name" name="category_name"
                            placeholder="Sub Category Name" value="{{ old('category_name') }}" required>
                    </div>
                </div>
            </div>
    ...
    <script>
        $('.btn-create-submit').on('click', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route('product.sub-category.store') }}',
                data: dataInput,
                success: function(data) {
                    ...
                    if (data.success == false) {
                        ...
                        $.toast({
                            heading: "Success!",
                            text: 'New Sub Category data successfully added.',
                            position: "top-right",
                            loaderBg: "#5ba035",
                            icon: "success",
                            hideAfter: 3e3,
