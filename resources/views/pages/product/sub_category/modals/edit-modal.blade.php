<div class="modal-content">
    ...
    <form id="edit-form" method="post">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Update Sub Category - {{ $sub_category->code }}</h4>
        </div>
            ...
            <div class="form-group">
                <div class="col-12 validate-input">
                    ...
                    <select class="form-control select2" required name="main_category" id="main_category" disabled>
                        <option value="{{$sub_category->main_category_id}}">{{$main_category->code . ' - ' . $main_category->main_category_name}}</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                <div class="col-12 edit-validate-input">
                    ...
                    <input class="form-control" type="text" id="edit-category_name" name="category_name"
                        placeholder="Sub Category Name" value="{{ $sub_category->category_name }}">
                </div>
            </div>
        </div>
...
<script>
    ...
    $('#btn-edit-submit').on('click', function(e) {
        ...
        $.ajax({
            type: 'PUT',
            url: '{{ route('product.sub-category.update', $sub_category) }}',
            data: dataInput,
            success: function(data) {
                ...
                $.toast({
                    heading: "Success!",
                    text: 'Sub Category data successfully updated.',
                    position: "top-right",
                    loaderBg: "#5ba035",
                    icon: "success",
                    hideAfter: 3e3,
