            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <div class="col-12 validate-input">
                        ...
                        <input class="form-control" type="text" id="specification_name" name="specification_name"
                            placeholder="Specification Name" value="{{ old('specification_name') }}" required>
                    </div>
                </div>
            </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.success == false) {
                        ...
                        $.toast({
                            heading: "Success!",
                            text: 'New Specification data successfully added.',
                            position: "top-right",
                            loaderBg: "#5ba035",
                            icon: "success",
                            hideAfter: 3e3,
