    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <div class="d-flex">
                        <h4 class="header-title mb-3">Main Category List</h4>
                        {{-- <div class="ml-auto">
                            <button type="button" class="btn btn-success waves-effect waves-light btn-rounded btn-add"
                                data-toggle="modal" data-target="#createModal" data-url="{{route('product.main-category.create')}}"><i
                                    class="mdi mdi-plus mr-1"></i> Add
                                New</button>
                        </div> --}}
