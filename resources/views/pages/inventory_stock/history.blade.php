...
<style>
    ...
    .stock-history-table .col-description,
    .stock-history-table .col-remark {
        white-space: normal;
        min-width: 220px;
    }
                        ...
                        <div class="col-sm-12 col-md-6">
                            ...
                            <p class="mb-1">
                                ...
                                <button type="button"
                                    ...
                                    data-trigger="focus"
                                    data-placement="top"
                                    data-content="Stock akhir hasil akumulasi seluruh event pada tabel history stock ini. Nilainya idealnya sama dengan Current Stock untuk scope PO, product, dan warehouse yang sama.">
                                    <i class="mdi mdi-information-outline"></i>
                                </button>
                            </p>
                            <p class="mb-0"><strong>Anchor Stock ID:</strong> {{ $inventoryStock->id }}</p>
                        </div>
                    </div>

                    @if($hasBalanceMismatch)
                        <div class="alert alert-warning mt-3 mb-0">
                            Ledger ending stock belum sama dengan current stock. Periksa event stock history terkait scope ini.
                        </div>
                    @endif
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body table-responsive">
                    <table class="table table-sm table-bordered stock-history-table mb-0">
                        ...
                        <tbody>
                            @forelse($events as $event)
                                <tr class="{{ $event['direction'] === 'in' ? 'stock-row-in' : 'stock-row-out' }}">
                                    <td>{{ $product->sku }}</td>
