...
class CountrySeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('countries')->insert([
            ['country_code' => '--', 'country_name' => 'Unknown'],
            ...
            ['country_code' => 'BA', 'country_name' => 'Bosnia and Herzegovi'],
            ...
            ['country_code' => 'CC', 'country_name' => 'Cocos (Keeling) Isla'],
            ['country_code' => 'CD', 'country_name' => 'Congo, Democratic Re'],
            ['country_code' => 'CF', 'country_name' => 'Central African Repu'],
            ...
            ['country_code' => 'FK', 'country_name' => 'Falkland Islands (Ma'],
            ['country_code' => 'FM', 'country_name' => 'Micronesia, Federate'],
            ...
            ['country_code' => 'GS', 'country_name' => 'South Georgia and th'],
            ...
            ['country_code' => 'HI', 'country_name' => 'Hawaii'],
            ['country_code' => 'HK', 'country_name' => 'Hong Kong'],
            ['country_code' => 'HM', 'country_name' => 'Heard Island and McD'],
            ...
            ['country_code' => 'IO', 'country_name' => 'British Indian Ocean'],
            ['country_code' => 'IQ', 'country_name' => 'Iraq'],
            ['country_code' => 'IR', 'country_name' => 'Iran, Islamic Republ'],
            ...
            ['country_code' => 'KN', 'country_name' => 'Saint Kitts and Nevi'],
            ['country_code' => 'KP', 'country_name' => 'Korea, Democratic Pe'],
            ...
            ['country_code' => 'LA', 'country_name' => 'Lao People s Democra'],
            ...
            ['country_code' => 'MF', 'country_name' => 'Saint Martin (French'],
            ['country_code' => 'MG', 'country_name' => 'Madagascar'],
            ['country_code' => 'MH', 'country_name' => 'Marshall Islands'],
            ['country_code' => 'MK', 'country_name' => 'Macedonia, the Forme'],
            ...
            ['country_code' => 'MP', 'country_name' => 'Northern Mariana Isl'],
            ...
            ['country_code' => 'PM', 'country_name' => 'Saint Pierre and Miq'],
            ...
            ['country_code' => 'SH', 'country_name' => 'Saint Helena, Ascens'],
            ['country_code' => 'SI', 'country_name' => 'Slovenia'],
            ['country_code' => 'SJ', 'country_name' => 'Svalbard and Jan May'],
            ...
            ['country_code' => 'ST', 'country_name' => 'Sao Tome and Princip'],
            ['country_code' => 'SV', 'country_name' => 'El Salvador'],
            ['country_code' => 'SX', 'country_name' => 'Sint Maarten (Dutch '],
            ['country_code' => 'SY', 'country_name' => 'Syrian Arab Republic'],
            ['country_code' => 'SZ', 'country_name' => 'Swaziland'],
            ['country_code' => 'TC', 'country_name' => 'Turks and Caicos Isl'],
            ['country_code' => 'TD', 'country_name' => 'Chad'],
            ['country_code' => 'TF', 'country_name' => 'French Southern Terr'],
            ...
            ['country_code' => 'TW', 'country_name' => 'Taiwan, Province of '],
            ['country_code' => 'TZ', 'country_name' => 'Tanzania, United Rep'],
            ['country_code' => 'UA', 'country_name' => 'Ukraine'],
            ['country_code' => 'UG', 'country_name' => 'Uganda'],
            ['country_code' => 'UM', 'country_name' => 'United States Minor '],
            ['country_code' => 'US', 'country_name' => 'United States'],
            ['country_code' => 'UY', 'country_name' => 'Uruguay'],
            ['country_code' => 'UZ', 'country_name' => 'Uzbekistan'],
            ['country_code' => 'VA', 'country_name' => 'Holy See (Vatican Ci'],
            ['country_code' => 'VC', 'country_name' => 'Saint Vincent and th'],
            ['country_code' => 'VE', 'country_name' => 'Venezuela, Bolivaria'],
            ['country_code' => 'VG', 'country_name' => 'Virgin Islands, Brit'],
